...
// Kustutab edetabeli ajad
void resetTimes() { timesCount = 0; }

// Muudab Hex koodi RGB väärtuseks
...
// ---------- POST funktsioonid ----------
// Numbriliste väärtuste lugemine
